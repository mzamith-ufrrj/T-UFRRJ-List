...
cppyy.include('sources.cpp/Configure.hpp')
...
def XML2BIN(xmlfilename):
    ...
    modelname = global_param[0].attributes['name'].value
    configure = Configure()
...
print('File: ', config, ' saved');
print('------------------------------')
#configure = Configure()
#configure.loadConfigFile(config)
#configure.print()
